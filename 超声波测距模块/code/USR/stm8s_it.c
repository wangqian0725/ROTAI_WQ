...
/**
 ...
 INTERRUPT_HANDLER(UART1_RX_IRQHandler, 18)
 {
    ...
    {
      send_data = get_data();
      send_data_h = send_data/0xff;
      send_data_l = send_data - send_data_h*0xff;
      UART1_Send_Byte(send_data_h);
      UART1_Send_Byte(send_data_l);
      UART1_Send_Byte(send_data_h+send_data_l);
